...
Looks like int, except for False and "". So, let's just use a grep to be extra sure if any fields have any alphabet or symbols, we will just say it's bad data.
```{r}
